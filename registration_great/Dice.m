clc;
input_folder = "path_to_your_files"; % Replace with your input folder path

% Define output file path
output_file = fullfile(getenv('USERPROFILE'), 'Desktop', 'Dice_results.txt'); % TXT file on desktop
...
standard_image = imresize(double(standard_image), 3, 'nearest'); % Nearest-neighbor interpolation
standard_image = standard_image > 0; % Convert to logical
