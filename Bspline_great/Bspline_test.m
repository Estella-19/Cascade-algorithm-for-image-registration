...
I1 = imread("path_to_your_image"); % Input Image (to be registered)
...
if size(I1, 3) == 3 && size(I2, 3) == 3
    ...
    % Start the b-spline nonrigid registration optimizer for R,G,B channel
    ...
    % Resize the transformed image to match the size of I1 (full image size)
