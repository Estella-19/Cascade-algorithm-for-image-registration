...
input_folder = "path_to_your_files";  % Replace with the actual folder path
output_folder = "path_to_your_files"; 

% Standard image (reference image)
I2 = imread("path_to_your_image"); % Standard Image
...
% Get list of all image files in the folder (adjust the file format if necessary)
...
for k = 1:length(image_files)
    ...
    if size(I1, 3) == 3 && size(I2, 3) == 3
        ...
        % Start the b-spline nonrigid registration optimizer for R, G, B channels
        ...
        % Resize the transformed image to match the size of I2 cropped region
        ...
        % Place the deformed image into the same position as the original I2's location in I1
...
% Display total registration time
